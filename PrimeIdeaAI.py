...
if aienv == None:
    openai.api_key = "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"
else:
...
if tgenv == None:
    tgkey = "5907879583:AAEZUvNNGjLzbQNmxoNHQ8Q1xUKL8lF-iso"
else:
    tgkey = tgenv
print(tgenv)
...
qcache = None
chat_log = None
botname = 'PrimeIdea AI'
username = 'PrimeIdea_AI_BOT'
